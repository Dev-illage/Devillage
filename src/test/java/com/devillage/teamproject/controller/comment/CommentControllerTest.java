        ...
        actions.andExpect(status().isCreated())
                ...
                .andDo(document(
                        ...
                        responseFields(
                                ...
                                fieldWithPath("avatar").type(JsonFieldType.OBJECT).description("작성자 프로필사진"),
                                fieldWithPath("avatar.fileId").description("프로필사진 식별자"),
                                fieldWithPath("avatar.filename").description("프로필사진 이름"),
                                fieldWithPath("avatar.remotePath").description("프로필사진 원격 주소"),
        ...
        actions.andExpect(status().isOk())
                ...
                .andDo(document(
                        ...
                        responseFields(
                                ...
                                fieldWithPath("data[].avatar").type(JsonFieldType.OBJECT).description("작성자 프로필사진"),
                                fieldWithPath("data[].avatar.fileId").description("프로필사진 식별자"),
                                fieldWithPath("data[].avatar.filename").description("프로필사진 이름"),
                                fieldWithPath("data[].avatar.remotePath").description("프로필사진 원격 주소"),
                                ...
                                fieldWithPath("data[].reComments[].avatar").type(JsonFieldType.OBJECT).description("작성자 프로필사진"),
                                fieldWithPath("data[].reComments[].avatar.fileId").description("프로필사진 식별자"),
                                fieldWithPath("data[].reComments[].avatar.filename").description("프로필사진 이름"),
                                fieldWithPath("data[].reComments[].avatar.remotePath").description("프로필사진 원격 주소"),
